...
const Catalog = () => {
    const [selectedCategory, setSelectedCategory] = useState("Chandilier");
    ...
    useEffect(() => {
        axios
            .get(
                `https://66607cbf5425580055b42150.mockapi.io/Chandilier?category=${selectedCategory}`
            )
            .then((response) => {
                setTableLamps(response.data);
                setLoading(false);
                ...
                <br />
                    <div className="catalog">
                        <div className="catalog_txt">
                            <h1>Каталог</h1>
                            <a href="#popular_products"><button>Весь каталог<FaArrowRightLong /></button></a>
                        </div>
                        <div className="cards">
                            {
                                lamps.map(el =>
                                    <div onClick={() => handleup3(el)} className="card" key={el.id}>
                    ...
                    <div className="catalog">
                        <div className="catalog_txt">
                            ...
                            <Link to={"/about_us"}><button>О компании<FaArrowRightLong /></button></Link>
                        </div>
                        <div className="carts">
                            <div className="cart">
                                <img src={icon1} alt="" />
                    ...
                    <br />
                    <br />
                    <div id="popular_products" className="catalog">
                        <div className="catalog_txt">
                            <h1>Популярные товары</h1>
                            <Link to={"/all_products"}><button>Все товары<FaArrowRightLong /></button></Link>
                        </div>
